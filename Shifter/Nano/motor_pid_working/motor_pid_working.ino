<<<<<<< HEAD:Shifter/motor_pid_working/motor_pid_working.ino
...
double kp = 50 , ki = 2.3 , kd = 0.01;             // modify for optimal performance
double input = 0, output = 0, setpoint = 0;
long temp;
volatile long encoderPos = 0;
unsigned long current, previous, interval=100;
...
>>>>>>> master:Shifter/Nano/motor_pid_working/motor_pid_working.ino
