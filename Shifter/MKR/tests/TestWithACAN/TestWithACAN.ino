...
static const byte MCP2515_CS  = 3 ; // CS input of MCP2515
static const byte MCP2515_SCK = 9 ; // SCK input of MCP2515
static const byte MCP2515_SI  = 8 ; // SI input of MCP2515
